...
class AssignmentStatementVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by AssignmentStatementParser#term_fact_multiply.
    def visitTerm_fact_multiply(self, ctx:AssignmentStatementParser.Term_fact_multiplyContext):
        return self.visitChildren(ctx)
