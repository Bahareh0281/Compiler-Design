...
class AssignmentStatementListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by AssignmentStatementParser#term_fact_multiply.
    def enterTerm_fact_multiply(self, ctx:AssignmentStatementParser.Term_fact_multiplyContext):
        pass

    # Exit a parse tree produced by AssignmentStatementParser#term_fact_multiply.
    def exitTerm_fact_multiply(self, ctx:AssignmentStatementParser.Term_fact_multiplyContext):
        pass
